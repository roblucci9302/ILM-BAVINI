...
describe('BaseChat', () => {
  ...
  describe('category prompts', () => {
    it('should send prompt when clicking category button', () => {
      ...
      expect(sendMessage).toHaveBeenCalledWith(
        expect.any(Object),
        'Crée-moi une landing page moderne et responsive'
      );
    });
  });
  ...
  describe('file handling', () => {
    ...
    it('should call onFileSelect when clicking attach button', () => {
      ...
      render(<BaseChat onFileSelect={onFileSelect} />);

      const attachButton = screen.getByTitle('Joindre une image');
  ...
  describe('enhance prompt', () => {
    ...
    it('should show loading state when enhancing', () => {
      const { container } = render(<BaseChat input="test" enhancingPrompt={true} />);

      expect(screen.getByText('Amélioration en cours...')).toBeInTheDocument();
    });

    it('should show enhanced state after prompt enhanced', () => {
      render(<BaseChat input="test" promptEnhanced={true} />);

      expect(screen.getByText('Prompt amélioré')).toBeInTheDocument();
    });
  });
