 ...
 * Reduces initial bundle size by ~80KB (gzipped) by deferring Shiki load
 */
export const LazyCodeBlockWrapper = memo(function LazyCodeBlockComponent(props: CodeBlockProps) {
  return (
