  ...
  return (
    ...
    >
      ...
      <IconButton
        ...
        className={classNames(
          'transition-colors',
          { 'text-bolt-elements-icon-success': copied },
        )}
      />
...
export const FloatingMessageActions = memo(({
  position = 'top-right',
  ...props
  ...
  return (
    <MessageActions
      ...
      className={classNames(
        ...
        'bg-bolt-elements-background-depth-1 rounded-md px-1 py-0.5 shadow-sm border border-bolt-elements-borderColor',
        props.className,
      )}
    />
  );
