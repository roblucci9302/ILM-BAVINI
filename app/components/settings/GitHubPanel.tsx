...
// SVG Spinner component (matches ConnectorCard pattern)
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <Spinner className="h-3 w-3" /> : <span className="i-ph:arrows-clockwise" />}
              Actualiser
            </button>
          </div>
...
const LoadingState = memo(() => (
  <div className="flex flex-col items-center justify-center py-16">
    <Spinner className="h-8 w-8 text-accent-500 mb-4" />
