...
function ColorBendsSkeleton({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <div
      ...
      style={{
        ...style,
        background: 'linear-gradient(135deg, rgba(20, 184, 166, 0.3), rgba(139, 92, 246, 0.3), rgba(236, 72, 153, 0.3))',
 ...
 */
export const LazyColorBendsWrapper = memo(function LazyColorBendsComponent(props: ColorBendsProps) {
  return (
