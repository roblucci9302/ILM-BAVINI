...
describe('Slider', () => {
  ...
  describe('selection', () => {
    it('should highlight left option when selected', () => {
      ...
      expect(leftButton).toHaveClass('text-bolt-elements-item-contentAccent');
    });
    ...
    it('should highlight right option when selected', () => {
      ...
      expect(rightButton).toHaveClass('text-bolt-elements-item-contentAccent');
    });
    ...
    it('should not highlight unselected option', () => {
      ...
      const rightButton = screen.getByText('Right Option').closest('button');
      expect(rightButton).toHaveClass('text-bolt-elements-item-contentDefault');
    });
  });
  ...
  describe('styling', () => {
    it('should have container styling', () => {
      ...
      expect(wrapper).toHaveClass('flex', 'items-center', 'rounded-full');
    });

    it('should have pill animation element for selected button', () => {
      const { container } = render(<Slider selected="left" options={defaultOptions} />);

      // Selected button has the pill background
      const pillBackground = container.querySelector('.bg-bolt-elements-item-backgroundAccent');
