  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 109 113" fill="none" className="w-full h-full">
        ...
        />
        <defs>
          <linearGradient id="supabase_gradient1" x1="53.9738" y1="54.974" x2="94.1635" y2="71.8295" gradientUnits="userSpaceOnUse">
            <stop stopColor="#249361" />
            <stop offset="1" stopColor="#3ECF8E" />
          </linearGradient>
          <linearGradient id="supabase_gradient2" x1="36.1558" y1="30.578" x2="54.4844" y2="65.0806" gradientUnits="userSpaceOnUse">
            <stop />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 256 256" fill="none" className="w-full h-full">
        <path d="M177.381 169.733L179.202 168.991L180.478 168.47L182.377 167.729L185.986 166.339V166.206L161.023 141.108H160.889L143.237 158.625L177.381 169.733Z" fill="#00C7B7" />
          ...
          <div key={connector.id} className="relative">
            <button
              ...
              className={classNames(
                ...
                {
                  'bg-bolt-elements-item-backgroundActive': activePopover === connector.id,
                  'opacity-100': isConnected,
                  'opacity-50 hover:opacity-80': !isConnected,
                }
              )}
