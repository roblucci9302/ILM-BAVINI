...
describe('DeviceSelector', () => {
  ...
  describe('device selection', () => {
    it('should select desktop by default', () => {
      ...
      // Desktop should be selected (has accent color)
      expect(desktopButton.className).toContain('text-bolt-elements-item-contentAccent');
    });
  ...
  describe('visual indicators', () => {
    it('should show selected device with accent color', () => {
      ...
      expect(tabletButton.className).toContain('text-bolt-elements-item-contentAccent');
    });
    ...
    it('should show unselected device with default color', () => {
      ...
      const tabletButton = screen.getByTitle('Tablette');
      expect(tabletButton.className).toContain('text-bolt-elements-item-contentDefault');
    });
  });
});
