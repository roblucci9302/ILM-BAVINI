...
describe('RLSGenerator', () => {
  ...
  describe('generate', () => {
    ...
    it('should use custom table configs when provided', () => {
      const schema = createTestSchema();
      const configs = [
        { table: 'posts', pattern: 'public' as const },
      ];
  ...
  describe('pattern detection', () => {
    it('should detect junction tables', () => {
      const junctionTable: Table = {
        ...
        schema: 'public',
        columns: [
          { name: 'post_id', type: 'uuid', nullable: false, isPrimaryKey: true, isForeignKey: true, isUnique: false, references: { table: 'posts', column: 'id' } },
          { name: 'tag_id', type: 'uuid', nullable: false, isPrimaryKey: true, isForeignKey: true, isUnique: false, references: { table: 'tags', column: 'id' } },
          { name: 'created_at', type: 'timestamptz', nullable: false, isPrimaryKey: false, isForeignKey: false, isUnique: false },
        ],
        indexes: [],
        constraints: [],
      };
