    ...
    it('should map uuid to string', () => {
      const schema: Schema = {
        tables: [{
          name: 'test',
          schema: 'public',
          columns: [{ name: 'id', type: 'uuid', nullable: false, isPrimaryKey: true, isForeignKey: false, isUnique: true }],
          indexes: [],
          constraints: [],
        }],
        rls: [],
    ...
    it('should map bool to boolean', () => {
      const schema: Schema = {
        tables: [{
          name: 'test',
          schema: 'public',
          columns: [{ name: 'is_active', type: 'bool', nullable: false, isPrimaryKey: false, isForeignKey: false, isUnique: false }],
          indexes: [],
          constraints: [],
        }],
        rls: [],
    ...
    it('should map jsonb to Json', () => {
      const schema: Schema = {
        tables: [{
          name: 'test',
          schema: 'public',
          columns: [{ name: 'data', type: 'jsonb', nullable: false, isPrimaryKey: false, isForeignKey: false, isUnique: false }],
          indexes: [],
          constraints: [],
        }],
        rls: [],
