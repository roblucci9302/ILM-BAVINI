...
describe('NLPValidator', () => {
  ...
  describe('validate', () => {
      ...
      const entities: ExtractedEntity[] = [
        {
          ...
          columns: [
            ...
            { name: 'email', inferredType: 'text', isRequired: true, isUnique: true, source: 'explicit', confidence: 90 },
          ],
          relations: [],
          source: 'explicit',
        },
      ...
      const entities: ExtractedEntity[] = [
        {
          name: 'user',
          tableName: 'user',
          columns: [{ name: 'id', inferredType: 'uuid', isRequired: true, isUnique: true, source: 'default', confidence: 100 }],
          relations: [],
          source: 'explicit',
        },
      ];
      ...
      const entities: ExtractedEntity[] = [
        {
          ...
          columns: [
            { name: 'id', inferredType: 'uuid', isRequired: true, isUnique: true, source: 'default', confidence: 100 },
            { name: 'select', inferredType: 'text', isRequired: false, isUnique: false, source: 'explicit', confidence: 80 },
          ],
          relations: [],
          source: 'explicit',
        },
      ...
      const entities: ExtractedEntity[] = [
        {
          name: 'item',
          tableName: 'items',
          columns: [{ name: 'name', inferredType: 'text', isRequired: true, isUnique: false, source: 'explicit', confidence: 80 }],
          relations: [],
          source: 'explicit',
        },
      ];
    ...
    it('should detect duplicate entity names', async () => {
      const entities: ExtractedEntity[] = [
        { name: 'user', tableName: 'users', columns: [{ name: 'id', inferredType: 'uuid', isRequired: true, isUnique: true, source: 'default', confidence: 100 }], relations: [], source: 'explicit' },
        { name: 'user2', tableName: 'users', columns: [{ name: 'id', inferredType: 'uuid', isRequired: true, isUnique: true, source: 'default', confidence: 100 }], relations: [], source: 'explicit' },
      ];
    ...
    it('should detect conflicts with existing tables', async () => {
      const entities: ExtractedEntity[] = [
        { name: 'profile', tableName: 'profiles', columns: [{ name: 'id', inferredType: 'uuid', isRequired: true, isUnique: true, source: 'default', confidence: 100 }], relations: [], source: 'explicit' },
      ];
