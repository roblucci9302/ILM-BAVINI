 ...
 */
export const DEFAULT_FIGMA_SCOPES = [
  FIGMA_SCOPES.FILE_READ,
  FIGMA_SCOPES.FILE_DEV_RESOURCES_READ,
];
 ...
 * Get file components
 */
export async function getFigmaComponents(accessToken: string, fileKey: string): Promise<Record<string, FigmaComponent>> {
