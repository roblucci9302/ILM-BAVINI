...
describe('useCheckpoints', () => {
  ...
  describe('initialization', () => {
    ...
    it('should auto-load checkpoints when autoLoad is true', async () => {
      ...
      expect(checkpointsDb.getCheckpointsByChat).toHaveBeenCalledWith(
        expect.anything(),
        'test-chat'
      );
    });
  ...
  describe('loadCheckpoints', () => {
    it('should load checkpoints from database', async () => {
      const mockCheckpoints = [
        createMockCheckpoint({ id: 'ckpt_1' }),
        createMockCheckpoint({ id: 'ckpt_2' }),
      ];
      vi.mocked(checkpointsDb.getCheckpointsByChat).mockResolvedValueOnce(mockCheckpoints);
    ...
    it('should handle load errors', async () => {
      vi.mocked(checkpointsDb.getCheckpointsByChat).mockRejectedValueOnce(
  ...
  describe('createCheckpoint', () => {
    ...
    it('should handle creation errors', async () => {
      vi.mocked(checkpointsDb.createCheckpoint).mockRejectedValueOnce(
  ...
  describe('restoreCheckpoint', () => {
    it('should restore a checkpoint', async () => {
      ...
      vi.mocked(checkpointsDb.createCheckpoint).mockResolvedValueOnce(
        createMockCheckpoint({ id: 'restore-point' })
      );
  ...
  describe('deleteCheckpoint', () => {
    it('should delete a checkpoint', async () => {
      ...
      expect(checkpointsDb.deleteCheckpoint).toHaveBeenCalledWith(
        expect.anything(),
        checkpoint.id
      );
    });
