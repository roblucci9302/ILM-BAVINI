    ...
    try {
      ...
      if (restoreFiles) {
        if (webcontainer) {
          ...
          const syncResult = await syncToSnapshot(
            webcontainer,
 ...
 */
export function createCheckpointService(options: ConstructorParameters<typeof CheckpointService>[0]): CheckpointService {
