...
export class NotionClient extends BaseHttpClient {
  ...
  async queryDatabase(
    ...
    return this.post<NotionListResult<NotionPage>>(
  ...
  async getBlockChildren(
    ...
    return this.get<NotionListResult<NotionBlock>>(
  ...
  async appendBlockChildren(
    ...
    return this.patch<NotionListResult<NotionBlock>>(
...
export function formatPageId(pageId: string): string {
  ...
  if (clean.length !== 32) return pageId;
